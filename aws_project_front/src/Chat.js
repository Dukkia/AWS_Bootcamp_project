...
const API_GATEWAY_ID = "u1bnwtzi0i";
const SOCKET_API_GATEWAY_ID = "ef12hnslsa";
  ...
  render() {
    return (
      ...
      >
        <MainContainer>
          <ChatContainer>
            <MessageList>{this.getMessageList()}</MessageList>
            <MessageInput placeholder="메시지 입력" onSend={this.onSend} />
          </ChatContainer>
        </MainContainer>
      </div>
    );
